...
class DT_Metrics_People_Groups_Overview extends DT_Metrics_Chart_Base
{
    //slug and title of the top menu folder
    public $base_slug = 'peoplegroups'; // lowercase
    public $slug = 'overview'; // lowercase
    public $base_title;
    public $title;
    public $js_object_name = 'wp_js_object'; // This object will be loaded into the metrics.js file by the wp_localize_script.
    public $js_file_name = '/dt-metrics/peoplegroups/overview.js'; // should be full file name plus extension
    ...
    public function __construct() {
        ...
        $this->base_title = __( 'People Groups', 'disciple_tools' );
...
new DT_Metrics_People_Groups_Overview();
